...
class ContactViewTest(TestCase):
    ...
    def test_get(self):
        tm1 = Contact(name='Dr Kelly Harris', description='Head, department of Life Sciences',
                      email='kelly.harris@uwimona.edu.jm', contact_type='FACULTY/STAFF', department='LIFE')
        tm1.save()
        tm1_expected = {
            'id': tm1.id,
            'name': tm1.name,
        ...
        tm2 = Contact(name='Police', department='OTHER',
                      contact_type='EMERGENCY')
        tm2.save()
        tm2_phone = PhoneNumber(
            phone='119', platforms='TEXT/CALL', contact=tm2)
        tm2_phone.save()
        tm2_expected = {
            'id': tm2.id,
            'name': tm2.name,
        ...
        tm3 = Contact(name='Department of Computing Main Office', website='https://uwi/compsci.html',
                      fax='(876) 390-4838', department='COMP', email='computing@uwimona.edu.jm', contact_type='OFFICE')
        tm3.save()
        tm3_phone1 = PhoneNumber(
            phone='(876) 983-4782', platforms='TEXT/CALL', contact=tm3)
        tm3_phone1.save()
        tm3_phone2 = PhoneNumber(
            phone='(876) 489-5892', platforms='TEXT/CALL', contact=tm3)
        tm3_phone2.save()
        tm3_expected = {
            'id': tm3.id,
            'name': tm3.name,
            ...
            'phone_contact_set': [
                {'id': 2, 'contact': 3,
                    'phone': '(876) 983-4782', 'platforms': 'TEXT/CALL'},
        ...
        tm4_phone = PhoneNumber(phone='(876) 278-2892',
                                platforms='WHATSAPP', contact=tm4)
        tm4_phone.save()
        tm4_expected = {
            'id': tm4.id,
            'name': tm4.name,
...
class EventViewTest(TestCase):
    ...
    def test_get(self):
        ...
        event1 = Event(name='General Orientation for New Undergraduate Students', start_date_time='2020-08-28T09:00:00Z',
                       end_date_time='2020-08-28T15:00:00Z', location='Online', poster_image='assets/general_orientation_poster.JPG')
        event1.save()
        event2 = Event(name='FST Virtual Orientation', start_date_time='2020-08-31T09:00:00Z',
                       end_date_time='2020-09-04T17:00:00Z', location='Online', poster_image='assets/fst_orientation_poster.JPG')
        event2.save()
...
class NewsFeedViewTest(TestCase):
    ...
    def test_get(self):
        # Create test models
        news_story1 = NewsFeed(title='News Story 1', date=datetime.date(
            2020, 4, 17), story='This is my first news story.', important=True)
        news_story1_image = NewsFeedImage(
            image="/images/news_feed_images/image.png", feed=news_story1)
        news_story1.save()
        news_story1_image.save()
        news_story2 = NewsFeed(title='News Story 2', date=datetime.date(
            2020, 5, 21), story='This is my second news story.', important=False)
        news_story2.save()
        ...
        expected_response = [{
            ...
            'important': 'true',
            'images': [{
                "image": "/images/news_feed_images/image.png"
            }, ]
        },
            {
            'id': news_story2.id,
